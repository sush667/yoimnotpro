...
class Menu3:
    ...
    def on_button3_clicked():
        ...
        if os.path.isfile(Find.program['chromium']):
            ...
            Menu3.chromium.set_tooltip_markup(format(SetToolTip('chromium', action.installed, action.remove_it)))
        else:
            Img.chromium_img.set_from_file(no)
            Menu3.chromium.set_tooltip_markup(format(SetToolTip('chromium', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['deluge']):
            Img.deluge_img.set_from_file(yes)
            Menu3.deluge.set_tooltip_markup(format(SetToolTip('deluge', action.installed, action.remove_it)))
        else:
            Img.deluge_img.set_from_file(no)
            Menu3.deluge.set_tooltip_markup(format(SetToolTip('deluge', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['evolution']):
            Img.evolution_img.set_from_file(yes)
            Menu3.evolution.set_tooltip_markup(format(SetToolTip('evolution', action.installed, action.remove_it)))
        else:
            Img.evolution_img.set_from_file(no)
            Menu3.evolution.set_tooltip_markup(format(SetToolTip('evolution', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['filezilla']):
            Img.filezilla_img.set_from_file(yes)
            Menu3.filezilla.set_tooltip_markup(format(SetToolTip('filezilla', action.installed, action.remove_it)))
        else:
            Img.filezilla_img.set_from_file(no)
            Menu3.filezilla.set_tooltip_markup(format(SetToolTip('filezilla', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['firefox']):
            Img.firefox_img.set_from_file(yes)
            Menu3.firefox.set_tooltip_markup(format(SetToolTip('firefox', action.installed, action.remove_it)))
        else:
            Img.firefox_img.set_from_file(no)
            Menu3.firefox.set_tooltip_markup(format(SetToolTip('firefox', action.not_here, action.install_it)))
        ...
        if os.path.isfile(Find.program['xchat']):
            ...
            Menu3.xchat.set_tooltip_markup(format(SetToolTip('xchat', action.installed, action.remove_it)))
        else:
            Img.xchat_img.set_from_file(no)
            Menu3.xchat.set_tooltip_markup(format(SetToolTip('xchat', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['liferea']):
            Img.liferea_img.set_from_file(yes)
            Menu3.liferea.set_tooltip_markup(format(SetToolTip('liferea', action.installed, action.remove_it)))
        else:
            Img.liferea_img.set_from_file(no)
            Menu3.liferea.set_tooltip_markup(format(SetToolTip('liferea', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['midori']):
            Img.midori_img.set_from_file(yes)
            Menu3.midori.set_tooltip_markup(format(SetToolTip('midori', action.installed, action.remove_it)))
        else:
            Img.midori_img.set_from_file(no)
            Menu3.midori.set_tooltip_markup(format(SetToolTip('midori', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['minitube']):
            Img.minitube_img.set_from_file(yes)
            Menu3.minitube.set_tooltip_markup(format(SetToolTip('minitube', action.installed, action.remove_it)))
        else:
            Img.minitube_img.set_from_file(no)
            Menu3.minitube.set_tooltip_markup(format(SetToolTip('minitube', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['opera']):
            Img.opera_img.set_from_file(yes)
            Menu3.opera.set_tooltip_markup(format(SetToolTip('opera', action.installed, action.remove_it)))
        else:
            Img.opera_img.set_from_file(no)
            Menu3.opera.set_tooltip_markup(format(SetToolTip('opera', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['pidgin']):
            Img.pidgin_img.set_from_file(yes)
            Menu3.pidgin.set_tooltip_markup(format(SetToolTip('pidgin', action.installed, action.remove_it)))
        else:
            Img.pidgin_img.set_from_file(no)
            Menu3.pidgin.set_tooltip_markup(format(SetToolTip('pidgin', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['skype']):
            Img.skype_img.set_from_file(yes)
            Menu3.skyp.set_tooltip_markup(format(SetToolTip('skype', action.installed, action.remove_it)))
        else:
            Img.skype_img.set_from_file(no)
            Menu3.skyp.set_tooltip_markup(format(SetToolTip('skype', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['steam']):
            Img.steam_img.set_from_file(yes)
            Menu3.steam.set_tooltip_markup(format(SetToolTip('steam', action.installed, action.remove_it)))
        else:
            Img.steam_img.set_from_file(no)
            Menu3.steam.set_tooltip_markup(format(SetToolTip('steam', action.not_here, action.install_it)))

        if os.path.isfile(Find.program['thunderbird']):
            Img.thunderbird_img.set_from_file(yes)
            Menu3.thunderbird.set_tooltip_markup(format(SetToolTip('thunderbird', action.installed, action.remove_it)))
        else:
            Img.thunderbird_img.set_from_file(no)
            Menu3.thunderbird.set_tooltip_markup(format(SetToolTip('thunderbird', action.not_here, action.install_it)))
        ...
        if os.path.isfile(Find.program['linuxdcpp']):
            ...
            Menu3.linuxdcpp.set_tooltip_markup(format(SetToolTip('linuxdcpp', action.installed, action.remove_it)))
        else:
            Img.linuxdcpp_img.set_from_file(no)
            Menu3.linuxdcpp.set_tooltip_markup(format(SetToolTip('linuxdcpp', action.not_here, action.install_it)))